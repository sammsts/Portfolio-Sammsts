...
const CardSocial = () => {
  return (
    <div className="card">
      <span><p>@</p></span>
      <a className="social-link" href="https://github.com/sammsts" target="_blank" title="GitHub">
        <i class="devicon-github-original colored"></i>
      </a>
      <a className="social-link" href="https://www.linkedin.com/in/samuelmacielsantos/" target="_blank" title="LinkedIn">
